        ...
        function nginxsslcert() {
                ...
                [ -z "$CERT_CN" ] && CERT_CN="www.microsoft.com"
                 ...
                 cd $SSL_LOCATION
                 sudo openssl req -x509 -nodes -days 365 -newkey rsa:2048 -keyout "server.key" -out "server.crt" -subj "/C=$CERT_COUNTRY/ST=$CERT_STATE/L=$CERT_LOCATION/O=$CERT_ORGANIZATION/OU=$CERT_OU/CN=$CERT_CN"
